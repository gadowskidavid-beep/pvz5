...
const PLANT_TREES := {
	...
	"wall": {"nodes": {
		"root":  {"n":"Panzer-Nuss","d":"Basis · Ueberall einsetzbar","cost":0,"req":"","pos":Vector2(0,0),"eff":{}},
	...
	"pilz": {"branches":[[-1.0,"Tempo"],[0.0,"Gift"],[1.0,"Reichweite"]], "nodes": {
		...
		"dmg1":   {"n":"Sporenkraft","d":"+30% Schaden","cost":8,"req":"root","pos":Vector2(0,1),"eff":{"dmg":0.30}},
		"rate1":  {"n":"Schnelle Sporen","d":"+25% Feuerrate","cost":12,"req":"root","pos":Vector2(-1,1),"eff":{"rate":0.25}},
		"poison": {"n":"Gift-Sporen","d":"Vergiftet Zombies (Schaden ueber Zeit)","cost":22,"req":"dmg1","pos":Vector2(0,2),"eff":{"poison":true}},
		"range":  {"n":"Weite Wolke","d":"+0,6 Reichweite","cost":18,"req":"dmg1","pos":Vector2(1,2),"eff":{"range":0.6}},
		...
		"nova":   {"n":"Sporen-Nova","d":"Legendär · Kettengift springt auf mehrere Zombies. Cooldown: 40 Sek.","cost":80,"req":"dmg2","pos":Vector2(0,4),"eff":{"chain":true,"poison":true},"rare":true,"cd":40},
	}},
	"sonnenpilz": {"nodes": {
		...
		"faster":  {"n":"Schnelles Wachstum","d":"-20% Produktionszeit","cost":12,"req":"amount1","pos":Vector2(-1,2),"eff":{"faster":0.20}},
		"hp":      {"n":"Zaehe Kappe","d":"+40% HP","cost":9,"req":"amount1","pos":Vector2(1,2),"eff":{"hp":0.40}},
		"amount2": {"n":"Nacht-Ertrag II","d":"+40% Sonne","cost":18,"req":"amount1","pos":Vector2(0,2),"eff":{"amount":0.40}},
		"twin":    {"n":"Doppelsporen","d":"Legendär · Produziert doppelte Sonne","cost":50,"req":"amount2","pos":Vector2(0,3),"eff":{"twin":true},"rare":true},
	}},
	"lilypad": {"nodes": {
		...
		"regen": {"n":"Wasserheilung","d":"+5 HP/s Selbstheilung","cost":18,"req":"hp1","pos":Vector2(-1,2),"eff":{"regen":5.0}},
		"thorns":{"n":"Scharfkantig","d":"Reflektiert 25% Schaden","cost":20,"req":"hp1","pos":Vector2(1,2),"eff":{"thorns":0.25}},
		"hp2":   {"n":"Panzerblatt","d":"+60% HP","cost":22,"req":"hp1","pos":Vector2(0,2),"eff":{"hp":0.60}},
	}},
	"wasserpilz": {"branches":[[-1.0,"Tempo"],[0.0,"Schaden"],[1.0,"Welle"]], "nodes": {
		...
		"rate1": {"n":"Schnellwurf","d":"+25% Feuerrate","cost":12,"req":"dmg1","pos":Vector2(-1,2),"eff":{"rate":0.25}},
		"splash":{"n":"Wellenradius","d":"+35% Splash-Radius","cost":16,"req":"dmg1","pos":Vector2(1,2),"eff":{"splash":0.35}},
		"dmg2":  {"n":"Druckwelle II","d":"+45% Schaden","cost":24,"req":"dmg1","pos":Vector2(0,2),"eff":{"dmg":0.45}},
		"poison":{"n":"Faulwasser","d":"Vergiftet Zombies","cost":30,"req":"splash","pos":Vector2(1,3),"eff":{"poison":true}},
		"flut":  {"n":"Sturzflut","d":"Legendär · Kettenwelle springt auf mehrere Zombies. Cooldown: 40 Sek.","cost":85,"req":"dmg2","pos":Vector2(0,3),"eff":{"chain":true},"rare":true,"cd":40},
	}},
	"frostbluete": {"branches":[[-1.0,"Tempo"],[0.0,"Frost"],[1.0,"Kontrolle"]], "nodes": {
		...
		"pierce": {"n":"Frost-Durchschuss","d":"Durchdringt +1 Zombie","cost":18,"req":"root","pos":Vector2(1,1),"eff":{"pierce":1}},
		"dmg2":   {"n":"Eisschuss II","d":"+40% Schaden","cost":22,"req":"dmg1","pos":Vector2(0,2),"eff":{"dmg":0.40}},
		"burn":   {"n":"Frostbrand","d":"Zusaetzlicher Schaden ueber Zeit","cost":28,"req":"rate1","pos":Vector2(-1,2),"eff":{"burn":true}},
		"schock": {"n":"Frostschock","d":"Legendär · Eisblitz springt auf mehrere Zombies. Cooldown: 35 Sek.","cost":80,"req":"dmg2","pos":Vector2(0,3),"eff":{"chain":true},"rare":true,"cd":35},
	}},
}
